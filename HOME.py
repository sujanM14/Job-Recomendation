...
url = load_lottieurl("https://lottie.host/7039931e-a7ee-4c46-b405-b567d8a09ac3/TQoDLVFnsc.json")

add_logo()
sidebar()


st.markdown("<h1 style='text-align: center; font-family: Verdana, sans-serif; padding: 20px; '>Welcome to ConnectionHire !</h1>", unsafe_allow_html=True)

st.markdown("<div style='background-color: teal; padding: 10px;'>", unsafe_allow_html=True)
